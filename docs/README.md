...
19. [Multilingual content and locale routing](./multilingual-content.md)
20. [Public theme settings](./theme-settings.md)
21. [Theme starter kits](./theme-starter-kits.md)
22. [Visual layout blocks](./visual-layout-blocks.md)
23. [Local fonts and privacy-first delivery](./local-fonts.md)
24. [Structured logging and operator alerts](./structured-logging.md)
25. [Scoped API keys](./api-keys.md)
26. [Outbound webhooks](./webhooks.md)
27. [Configurable mail delivery](./mail-delivery.md)
28. [Database health and retention](./database-health.md)
29. [Operational metrics](./operational-metrics.md)
30. [Automated off-site backups](./automated-backups.md)
31. [Background rendering jobs](./background-jobs.md)
32. [XServer hybrid deployment](./xserver-hybrid-deployment.md)
33. [Roadmap](./roadmap.md)
33. [VPS production guide](./vps.md)
34. [Upgrade guide](./upgrade.md)
35. [Architecture decision records](./adr/0001-public-html-coexistence.md)
